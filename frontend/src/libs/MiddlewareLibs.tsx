...
import { axiosHttpRequest } from "./ApiLibs";
import { getTokenFromLocalCookie, unsetToken } from "./AuthLibs";
import { ChildrenProps } from "../DataTypes/GlobalInterface";

export const Middleware = ({ children }: ChildrenProps) => {
    return (<>{children}</>);
};

// kalau dah auth tapi mau ke page login. kita bakal tendang
export const Guest = ({ children }: ChildrenProps) => {
...
export const Public = ({ children }: ChildrenProps) => {
    useEffect(() => {
